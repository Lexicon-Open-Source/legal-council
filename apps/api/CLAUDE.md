...
Past problems solved, with searchable frontmatter: **[docs/solutions/](docs/solutions/)**

Organized by category (`integration-issues/`, `database-issues/`, `performance-issues/`, etc.) with YAML frontmatter (`module`, `tags`, `problem_type`, `component`, `root_cause`). Relevant when debugging or implementing in documented areas — covers bugs, best practices, and workflow patterns.
