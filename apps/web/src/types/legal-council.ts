 ...
 */
export type CouncilMemberRole = 'strict' | 'humanist' | 'historian';
...
export interface CasePrecedent {
  ...
  verdict_summary?: string; // Added for flexibility
  case_number?: string; // Added for flexibility
}
...
export interface LegalArguments {
...
export const COUNCIL_MEMBERS: Record<CouncilMemberRole, CouncilMember> = {
  strict: {
    ...
    description: 'Menafsirkan unsur pasal dan batas kewenangan secara ketat',
    perspective:
  ...
  humanist: {
    ...
    description: 'Menimbang rehabilitasi, pemulihan, dan faktor yang meringankan',
  ...
  historian: {
    ...
    description: 'Membaca pola yurisprudensi dan putusan pembanding',
