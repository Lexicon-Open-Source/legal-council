...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "data-[highlighted]:bg-secondary data-[highlighted]:text-secondary-foreground relative flex w-full cursor-default items-center rounded-sm py-1.5 pr-2 pl-6 text-sm outline-none select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className
    )}
    {...props}
  >
